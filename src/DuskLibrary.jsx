...
function sourceFavicon(source, publisher) {
  const domain = SOURCE_DOMAIN[source] || SOURCE_DOMAIN[publisher];
            ...
            <div style={{
              ...
              <div style={{ padding: "8px 0" }}>
                {startHereItems.map((item, idx) => (
                  ...
                  >
                    {sourceFavicon(item.source, item.publisher) ? (
                      <img src={sourceFavicon(item.source, item.publisher)} alt="" width="20" height="20"
      ...
      <article className="start-card-hover" style={{
        ...
        <div style={{
          ...
          <span style={{
            ...
            {sourceFavicon(item.source, item.publisher) && (
              <img src={sourceFavicon(item.source, item.publisher)} alt="" width="14" height="14"
    ...
    >
      ...
      <div style={{
        ...
        <span style={{
          ...
          {sourceFavicon(item.source, item.publisher) && (
            <img src={sourceFavicon(item.source, item.publisher)} alt="" width="18" height="18"
